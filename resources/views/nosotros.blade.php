        ...
        <div class="row g-4 text-center">
            <div class="col-md-4">
                <div class="p-4 border rounded-3 h-100 shadow-sm card-hover">
                    ...
                    <p class="text-muted small">Mujeres embarazadas, niñas y niños de 0 a 3 años de edad, y comunidades educativas. Nos enfocamos en familias en condiciones de vulnerabilidad socioeconómica, especialmente aquellas dentro de programas de ayuda social.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="p-4 border rounded-3 h-100 shadow-sm card-hover">
                    ...
                    <p class="text-muted small">Las familias de nuestros beneficiarios directos, su entorno inmediato y la sociedad en general, promoviendo un impacto positivo en la salud materno-infantil.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="p-4 border rounded-3 h-100 shadow-sm card-hover">
                    ...
                    <p class="text-muted small">Inicialmente concentrados en Luque y zonas aledañas del Departamento Central de Paraguay, con planes de expansión a otras ciudades a futuro.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card h-100 border-0 shadow-sm card-hover p-4 text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted small">Fortalecer la atención primaria de salud con tratamientos educativos, preventivos y curativos.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
                <div class="card h-100 border-0 shadow-sm card-hover p-4 text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted small">Rehabilitar las necesidades odontológicas de mujeres embarazadas en todas las especialidades de la odontología.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
                <div class="card h-100 border-0 shadow-sm card-hover p-4 text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted small">Disminuir riesgos de partos prematuros y abortos causados por infecciones bucales.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
                <div class="card h-100 border-0 shadow-sm card-hover p-4 text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted small">Promover la autoestima de las mujeres embarazadas portadoras de problemas odontológicos.</p>
                    </div>
                </div>
            </div>
        </div>
